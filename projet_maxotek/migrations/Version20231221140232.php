 ...
 */
final class Version20231221140232 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE administrateur (id INT AUTO_INCREMENT NOT NULL, admin_nom VARCHAR(50) NOT NULL, admin_prenom VARCHAR(50) NOT NULL, email VARCHAR(180) NOT NULL, password VARCHAR(255) NOT NULL, roles JSON NOT NULL, UNIQUE INDEX UNIQ_32EB52E8E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE adresse (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, fournisseur_id INT DEFAULT NULL, adresse VARCHAR(255) NOT NULL, adresse_ville VARCHAR(50) NOT NULL, adresse_cp VARCHAR(5) NOT NULL, INDEX IDX_C35F0816A76ED395 (user_id), INDEX IDX_C35F0816670C757F (fournisseur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, categ_princip_id INT DEFAULT NULL, categ_libelle VARCHAR(50) NOT NULL, categ_photo LONGBLOB NOT NULL, INDEX IDX_497DD634842823C8 (categ_princip_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE facturation (id INT AUTO_INCREMENT NOT NULL, facture_adresse_id INT NOT NULL, facture_com_id INT NOT NULL, facture_date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_17EB513AA7F83358 (facture_adresse_id), INDEX IDX_17EB513A211B1D90 (facture_com_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE fournisseur (id INT AUTO_INCREMENT NOT NULL, fournis_pays_id INT NOT NULL, fournis_nom VARCHAR(50) NOT NULL, fournis_tel VARCHAR(20) NOT NULL, fournis_email VARCHAR(100) NOT NULL, INDEX IDX_369ECA3253046811 (fournis_pays_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE livraison_inclut (id INT AUTO_INCREMENT NOT NULL, produit_id INT NOT NULL, livraison_id INT NOT NULL, quantite INT NOT NULL, INDEX IDX_FC2060C8F347EFB (produit_id), INDEX IDX_FC2060C88E54FB25 (livraison_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE produit (id INT AUTO_INCREMENT NOT NULL, produit_categ_id INT NOT NULL, produit_fournis_id INT NOT NULL, produit_libelle VARCHAR(50) NOT NULL, produit_descrip LONGTEXT NOT NULL, produit_prixachat DOUBLE PRECISION NOT NULL, produit_prixht DOUBLE PRECISION NOT NULL, produit_photo LONGBLOB NOT NULL, produit_stock INT NOT NULL, produit_active TINYINT(1) NOT NULL, INDEX IDX_29A5EC27C1086901 (produit_categ_id), INDEX IDX_29A5EC27CC805D89 (produit_fournis_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, user_pays_id INT NOT NULL, user_commerc_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, user_nom VARCHAR(50) NOT NULL, user_prenom VARCHAR(50) NOT NULL, user_sexe VARCHAR(1) NOT NULL, user_tel VARCHAR(20) NOT NULL, user_type VARCHAR(30) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649FEE95C4E (user_pays_id), INDEX IDX_8D93D64937D0AE5A (user_commerc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD634842823C8 FOREIGN KEY (categ_princip_id) REFERENCES categorie (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie DROP FOREIGN KEY FK_497DD634842823C8');
